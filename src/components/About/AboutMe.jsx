    ...
    <section className="w-full">
      ...
      <div className="flex flex-col md:flex-row w-full mb-20">
        <div className="md:w-1/2 h-1/2 md:h-auto p-12">
          <img src='https://media.placester.com/image/upload/c_fill,f_auto,q_80,w_400/v1/inception-app-prod/MDlhMGFlNmQtNmM3My00MDg3LTk5YjktNmY3MmE4NzdkOWU5/logo/2019/05/Courtney_Newton_HighRes_Crop.jpg' alt="About Us" className="object-cover w-full h-full" />
        </div>
