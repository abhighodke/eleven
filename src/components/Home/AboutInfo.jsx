  ...
  return (
    <div className="bg-white mt-12 py-16 px-8 flex flex-col lg:flex-row items-center lg:items-start justify-between">
      ...
      <div className="lg:w-1/2 w-full mt-6">
        ...
        <img src="https://media.placester.com/image/upload/c_fill,f_auto,q_80,w_400/v1/inception-app-prod/MDlhMGFlNmQtNmM3My00MDg3LTk5YjktNmY3MmE4NzdkOWU5/logo/2019/05/Courtney_Newton_HighRes_Crop.jpg" alt="About" className="w-full h-auto object-cover" />
      </div>
    </div>
  );
};
